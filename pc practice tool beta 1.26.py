...
winning_requirement2 = Label(winning_requirement_header, text = "do a pc", font=('Arial', 15), fg='black')  
...
def try_a_piece():
    ...
    if try_drop():
        ...
        test = test and mygame.get_max_height()<4
...
#-----------------------------------------------------------#
ds_button1 = Button(root, text="pc practice", width=20, height=1, font=('Arial', 20), command = play_a_combopc_map)
